  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-20 right-20 w-96 h-96 bg-primary/20 rounded-full blur-[120px] animate-pulse-glow" />
        <div className="absolute bottom-20 left-20 w-96 h-96 bg-primary/15 rounded-full blur-[120px] animate-pulse-glow animation-delay-2000" />
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 text-center pt-20">
          <div className="max-w-6xl mx-auto space-y-8 animate-fade-in-up">
            ...
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tight text-balance leading-[0.95]">
              The way of the{" "}
              <span className="text-gradient relative">
                sword
                <div className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-primary to-transparent blur-sm" />
              </span>
            </h1>
      ...
      <section className="py-32 lg:py-40">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center max-w-7xl mx-auto">
            <div className="order-2 lg:order-1 relative aspect-[4/5] group">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="group relative p-8 rounded-xl glass border border-primary/20 hover:border-primary/40 transition-all hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/10">
      ...
      <section className="py-32 lg:py-40 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 text-center relative z-10">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-8 tracking-tight text-balance">
              Begin your journey
            </h2>
            <p className="text-lg md:text-xl text-muted-foreground mb-12 leading-relaxed">
              Find a club near you and start training with experienced instructors today. All levels welcome.
            </p>
